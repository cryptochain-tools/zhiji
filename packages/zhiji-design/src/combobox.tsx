...
/**
 * Combobox v2.2 redesign:
 *  - Popup: `ring-foreground/10` → `border-border-subtle + shadow-card`.
 *  - ComboboxItem highlighted: `bg-accent text-accent-foreground` (brand).
 *  - ComboboxChips: `bg-card` (was bg-transparent) for visible chip surface.
 *  - Chip background: `bg-muted` consistent with Badge secondary.
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            ...
            "border border-border-subtle bg-popover text-popover-foreground shadow-card duration-100",
            ...
            "*:data-[slot=input-group]:border-input *:data-[slot=input-group]:bg-card *:data-[slot=input-group]:shadow-none",
...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        "px-2 py-1.5 text-xs font-semibold uppercase tracking-wide text-foreground-tertiary",
        className
      )}
      {...props}
    />
...
function ComboboxEmpty({ className, ...props }: ComboboxPrimitive.Empty.Props) {
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "hidden w-full justify-center py-3 text-center text-sm text-muted-foreground",
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex min-h-9 flex-wrap items-center gap-1 rounded-lg border border-input bg-card",
        "px-2.5 py-1 text-sm transition-[border-color,background-color,box-shadow] duration-fast ease-out",
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        ...
        "rounded-md bg-muted px-2 text-xs font-medium whitespace-nowrap text-foreground",
