...
/**
 * ContextMenu v2.2 redesign:
 *  - Popup: `ring-foreground/10` → `border-border-subtle + shadow-card`
 *    (matches DropdownMenu / Select unified popup vocabulary).
 *  - Item hover: `bg-accent text-accent-foreground` (brand-muted bg, brand-text fg).
 *  - Destructive item: `bg-destructive/10` on focus.
 *  - Separator: `bg-border-subtle` (lighter divider).
 */
...
const popupClass = cn(
  ...
  "border border-border-subtle bg-popover p-1 text-popover-foreground shadow-card",
...
const itemClass = cn(
  "group/context-menu-item relative flex cursor-default items-center gap-1.5",
...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-1.5 rounded-md px-1.5 py-1.5 text-sm",
