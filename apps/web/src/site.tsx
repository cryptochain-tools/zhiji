...
function Footer() { return <footer className="public-footer"><div className="wrap public-footer-grid"><div><Link className="brand-link" href="/"><Brand /></Link><p>了解用户，发现问题。<br />把每一次改进，做得更有依据。</p><span className="public-footer-note">产品分析 · 错误监控 · 自部署</span></div>{footerGroups.map(group => <div key={group.title}><h2>{group.title}</h2>{group.links.map(([title,href]) => <Link key={href} href={href}>{title}</Link>)}</div>)}</div><div className="wrap public-footer-bottom"><span>知迹 · 为认真打磨产品的团队而做</span><div><a href="https://github.com/earntools-labs/zhiji" target="_blank" rel="noreferrer">GitHub</a><a href="https://github.com/earntools-labs/zhiji/blob/main/LICENSE" target="_blank" rel="noreferrer">AGPL-3.0</a><a href="https://github.com/earntools-labs/zhiji/blob/main/CONTRIBUTING.md" target="_blank" rel="noreferrer">贡献指南</a><a href="https://github.com/earntools-labs/zhiji/security/policy" target="_blank" rel="noreferrer">安全报告</a></div></div></footer> }
